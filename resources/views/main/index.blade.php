                            ...
                            <div class="new__mini">
                                ...
                                <div class="new__mini-blog">
                                    <div class="new__state">
                                        ...
                                        <div class="new__state__text">
                                            <p>каойто текст статьи который я написал только что, не обращайте внимание<a href="{{ route('news.show', [ 'id' => $newsValue->id ]) }}">Читать дальше</a></p>
                                        </div>
                                    </div>
    ...
    <div class="books">
        ...
        <div class="cbooks_wrap">
            ...
            <div class="books__text">
                ...
                <input type="submit" name="books" value="Все книги">
            </div>
        </div>
    </div>
